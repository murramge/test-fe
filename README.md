...
| 카테고리       | 기술                                       | 선택 이유                                                          |
| -------------- | ------------------------------------------ | ------------------------------------------------------------------ |
| **프레임워크** | React Native + Expo                        | 간편한 설정, 빠른 시작, 실시간 미리보기, 통합 개발환경             |
| **언어**       | TypeScript                                 | 타입 안전성, 개발 생산성 향상, 팀 협업 효율성                      |
| **스타일링**   | NativeWind (Tailwind CSS for React Native) | 빠른 UI 개발, 일관된 디자인 시스템, 타입 안전성                    |
| **네비게이션** | Expo Router (파일 기반 라우팅)             | 직관적 구조, Next.js와 유사한 패턴, 타입 안전 라우팅               |
| **상태관리**   | Zustand                                    | 단순한 API, 적은 보일러플레이트, 선택적 구독으로 성능 최적화       |
| **로컬저장소** | React Native MMKV                          | 빠른 읽기/쓰기 성능, 동기식 API, 암호화 지원                       |
| **폼관리**     | React Hook Form + Zod                      | 성능 최적화(비제어 컴포넌트), 타입 안전 스키마, 강력한 유효성 검증 |
| **개발도구**   | ESLint, TypeScript, Prettier               | 코드 품질 유지, 일관된 포맷팅, 팀 협업 효율성                      |
...
- **선택 이유**:
  ...
  - 통합 개발환경: 빌드, 배포, 디버깅 모든 과정 간소화

#### **TypeScript**

- **대안**: JavaScript (타입 안전성 부족), Flow (커뮤니티 지원 부족)
- **선택 이유**:
  - 컴파일 타임 에러 감지로 런타임 버그 방지
  - IDE 자동완성과 리팩토링 지원
  - 팀 개발 시 코드 가독성과 유지보수성 향상

#### **Zustand**

- **대안**: Redux Toolkit (복잡성, 학습곡선), Jotai (원자적 상태의 복잡성)
- **선택 이유**:
  - 적은 보일러플레이트 코드로 빠른 개발
  - 직관적인 API로 빠른 학습과 개발
  - 선택적 구독으로 불필요한 리렌더링 방지

#### **React Native MMKV**

- **대안**: AsyncStorage (느린 속도, 비동기 복잡성), SecureStore (용량 제한)
- **선택 이유**:
  - 뛰어난 읽기/쓰기 성능
  - 동기식 API로 간단한 사용법
  - 암호화 지원으로 민감한 데이터 보호
...
| <img width="250" height="542" alt="온보딩 화면" src="https://github.com/user-attachments/assets/ea333faa-e706-41b3-9b1c-6554a7ffefa5" /> | <img width="250" height="542" alt="로그인 화면" src="https://github.com/user-attachments/assets/d0a2014e-61f9-4be1-a40e-f3effc72ae4c" /> | <img width="250" height="542" alt="회원가입 화면" src="https://github.com/user-attachments/assets/db0e965f-513a-4c6f-887f-05d22a525f43" /> |
| :--------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------: |
...
| <img width="250" height="542" alt="홈 대시보드" src="https://github.com/user-attachments/assets/b74cab1b-9790-4e8b-82e6-6adc510405c6" /> | <img width="250" height="542" alt="빠른 할일 추가" src="https://github.com/user-attachments/assets/bc288c61-4bc9-4d05-b65e-b06127461ec4" /> |
| :--------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------: |
...
| <img width="250" height="542" alt="할일 목록" src="https://github.com/user-attachments/assets/e4148021-c83c-4dc1-8c4d-24f1d8dafff9" /> | <img width="250" height="542" alt="할일 추가" src="https://github.com/user-attachments/assets/c9dd9216-2731-4c37-8e79-f5be8e20eded" /> | <img width="250" height="542" alt="할일 편집" src="https://github.com/user-attachments/assets/91587ac9-0453-4cbc-8526-6ef90e2026b6" /> | <img width="250" height="542" alt="카테고리 관리" src="https://github.com/user-attachments/assets/48140727-072c-4ca7-8372-3af32aa00655" /> | <img width="250" height="542" alt="설정" src="https://github.com/user-attachments/assets/52c41b4f-64b4-480e-80f2-bacca4ba118d" /> |
| :------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------: |
...
| <img width="250" height="542" alt="통계 차트" src="https://github.com/user-attachments/assets/aa8b299d-67d7-432c-948a-ad006ad521b1" /> | <img width="250" height="542" alt="생산성 분석" src="https://github.com/user-attachments/assets/0f7f73d3-6416-42c1-86cb-78ef297e0194" /> |
| :------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------: |
...
| <img width="250" height="542" alt="다크 모드" src="https://github.com/user-attachments/assets/960031b3-18f1-4587-85f9-f6900a5711d0" /> | <img width="250" height="542" alt="라이트 모드" src="https://github.com/user-attachments/assets/1ec3a544-ba51-4fc0-a494-86045a6c4cf4" /> |
| :------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------: |

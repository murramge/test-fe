...
| **로컬저장소** | React Native MMKV                          | AsyncStorage 대비 30배 빠른 읽기/쓰기, 동기식 API, 암호화 지원     |
...
- **선택 이유**:
  - 간편한 설정: Xcode/Android Studio 없이도 개발 가능
...
- **선택 이유**:
  - AsyncStorage 대비 30배 빠른 읽기/쓰기 성능
  - 동기식 API로 간단한 사용법
  - 암호화 지원으로 민감한 데이터 보호
  - 크로스플랫폼 일관된 성능
